export const calculateMakros=(foodLogs,numDays)=>{
    ...
    console.log(numDays,Object.keys(foodLogs).length,"nmmm")
    console.log(numDays>Object.keys(foodLogs).length,"boo")
    if(numDays<Object.keys(foodLogs).length){
        ...
        console.log(Object.keys(foodLogs),"kucuk")
